...
echo "$van \033[1;97mBản Quyền : \033[1;93m  Thanh Nh�\n";

echo "$van \033[1;97YYTB: \033[1;32m MOD APK GAME  \n";

echo "$van \033[1;97mZalo:0869922524  \n";

echo "$van \033[1;97mTool : Spam Sms \n";
